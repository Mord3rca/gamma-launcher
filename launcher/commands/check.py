...
class CheckMD5:
    ...
    def _purge_unused_files(self, dl_dir: Path, downloaders) -> None:
        files_in_use = set(i.archive for i in downloaders)
        ...
        for archive in dl_dir.iterdir():
            ...
            print(f"[+] Purging {archive.name} from {dl_dir}...")
            #archive.unlink()
    ...
    def run(self, args) -> None:
        ...
        if args.remove_unused:
           self._purge_unused_files(dl_dir, downloaders.values())
